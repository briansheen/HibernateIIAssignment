...
public class Main {
    ...
    private void doit() {
        ...
        student.setName("Zebra " + System.currentTimeMillis());
        session.save(student);

        student = (Student) session.createQuery("select s from Student s where s.id = :id").setParameter("id",23).uniqueResult();
